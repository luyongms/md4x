...
---
## Rust specific
- Use cargo check --message-format=short instead of cargo build.
- Scope to single crates with -p.
- Don't run full cargo test — target specific tests with cargo test test_name.
---
